    ...
    async execute(message, args, client, lang) {
        ...
        if (args[0]) {
            ...
            const embed = new Discord.MessageEmbed()
                .setColor(color)
        .setAuthor("📃 • Page d'aide de BetterGuard leak by dx")
                ...
                .addField(`${emojis.settings} ・**${lang.HelpDescriptionCategoryUtils}**`,"\`help\`, \`pic\`, \`ping\`, \`userinfo\`, \`serverinfo\`, \`botinfo\`, \`warnings\`, \`invite\`, \`snipe\`, \`mybots\`")
